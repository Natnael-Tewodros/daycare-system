...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var args, childId, daysAgo, status, date, attendance, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    childId = Number(args[0]);
                    daysAgo = Number(args[1]);
                    status = args[2] || "present";
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, prisma_1.prisma.attendance.create({
                            data: {
                                childId: childId,
                                status: status,
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error("Failed to insert attendance:", err_1);
                    process.exit(4);
                    return [3 /*break*/, 4];
